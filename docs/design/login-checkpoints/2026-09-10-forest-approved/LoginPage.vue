<template>
  <main class="login-page">
    <img class="scene-background" src="/@/assets/login/fire-response-panorama-forest-v6.png" alt="林区无人机消防合成场景：近景运载机通过长吊索悬挂红色灭火桶洒水，浅灰白 FlyCart 200 通过长吊索悬挂红色运输包，M4T 与降低位置的 M4TD 巡查火点，无现场人员" />
      ...
      <section class="login-story" aria-labelledby="platform-title">
        ...
        <footer class="scene-caption">
          <div class="response-flow" aria-label="无人机协同消防场景">
            <span><b>01</b> 火情巡检</span><span><b>02</b> 救援吊运</span><span><b>03</b> 吊桶灭火</span>
          </div>
