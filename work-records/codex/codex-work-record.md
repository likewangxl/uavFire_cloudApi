...
- Backend: `backend/sample/src/main/java/com/dji/sample/control/service/impl/ControlServiceImpl.java`
...
- Backend: `backend/sample/src/main/java/com/dji/sample/control/model/param/TakeoffToPointParam.java`
...
- Ran backend compile with `mvn -pl sample -DskipTests compile`; compile completed with existing Maven warnings.
