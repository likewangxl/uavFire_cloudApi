...
test('normalizeDualStreamGroup maps snake_case backend fields to camelCase frontend fields', () => {
  const normalized = normalizeDualStreamGroup({
    ...
    visible_play_url: 'webrtc://192.168.50.254:58925/live/RC_PLUS_LOCAL-0',
  ...
  assert.equal(normalized.visiblePlayUrl, 'webrtc://192.168.50.254:58925/live/RC_PLUS_LOCAL-0')
