...
test('delivery execution panel renders fc100 live and status sections', () => {
  ...
  assert.match(source, /delivery-live-badge/)
  assert.match(source, /delivery-live-hud/)
  assert.match(source, /delivery-flight-hud/)
  assert.match(source, /delivery-hud-message/)
  assert.match(source, /buildDeliveryExecutionHud/)
  assert.match(source, /FC100 投放主画面/)
  assert.match(source, /taskPhase/)
  assert.match(source, /taskProgress/)
  assert.match(source, /aircraftStatus/)
})
