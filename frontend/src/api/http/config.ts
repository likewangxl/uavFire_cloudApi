const backendHost = (import.meta.env.VITE_APP_APIGATEWAY_BACKEND_HOST || 'http://192.168.31.51:6789').replace(/\/$/, '')
...
export const CURRENT_CONFIG = {
  ...
  rtmpURL: 'rtmp://192.168.31.51:1935/live/', // Example: 'rtmp://192.168.1.1/live/'
