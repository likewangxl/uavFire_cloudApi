  ...
  <div class="width100 flex-column flex-justify-start flex-align-start" style="background-color: white;">
    ...
    >
      ...
      >
        ...
        <a-radio-button :value="EDownloadOwner.Others">其他人</a-radio-button>
      </a-radio-group>
    </div>
  </div>
  </a-layout>
...
onMounted(() => {
  console.error('上传照片类型：', apiPilot.getUploadPhotoType())
  console.error('是否自动上传视频：', apiPilot.getAutoUploadVideo())
})
</script>
