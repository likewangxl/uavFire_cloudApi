...
CREATE TABLE `planned_wayline` (
  ...
  `route_kind` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'waypoint' COMMENT 'waypoint/patrol/area',
  `area_polygon_json` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'Area boundary vertices in GCJ02 and WGS84.',
  `area_camera_key` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Camera preset used by mapping2d.',
  `area_front_overlap` int DEFAULT NULL COMMENT 'mapping2d forward overlap percent.',
  `area_side_overlap` int DEFAULT NULL COMMENT 'mapping2d side overlap percent.',
  `area_heading_deg` double DEFAULT NULL COMMENT 'mapping2d direction, north clockwise degrees.',
