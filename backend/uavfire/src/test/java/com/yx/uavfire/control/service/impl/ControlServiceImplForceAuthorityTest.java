...
class ControlServiceImplForceAuthorityTest {
    ...
    private static class RecordingControlServiceImpl extends ControlServiceImpl {
        ...
        @Override
        public HttpResultResponse seizeAuthority(String sn, com.yx.uavfire.control.model.enums.DroneAuthorityEnum authority,
                                                 com.yx.uavfire.control.model.param.DronePayloadParam param, boolean force) {
