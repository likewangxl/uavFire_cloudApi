package com.yx.uavfire.component.mqtt.config;

import com.auth0.jwt.algorithms.Algorithm;
import com.yx.uavfire.common.util.JwtUtil;
import com.yx.uavfire.component.mqtt.model.MqttClientOptions;
import com.yx.uavfire.component.mqtt.model.MqttProtocolEnum;
import com.yx.uavfire.component.mqtt.model.MqttUseEnum;
...
public class MqttPropertyConfiguration {
    ...
    public static DrcModeMqttBroker getMqttBrokerWithDrc(String clientId, String username, Long age, Map<String, ?> map) {
        ...
        String token = JwtUtil.createToken(map, age * 1000, algorithm, null, null);
