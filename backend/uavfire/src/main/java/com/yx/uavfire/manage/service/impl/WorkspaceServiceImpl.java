...
import com.yx.uavfire.manage.dao.IWorkspaceMapper;
import com.yx.uavfire.manage.model.dto.WorkspaceDTO;
import com.yx.uavfire.manage.model.entity.WorkspaceEntity;
...
public class WorkspaceServiceImpl implements IWorkspaceService {
    ...
    public Optional<WorkspaceDTO> getDefaultWorkspace() {
        return Optional.ofNullable(entityConvertToDto(
                mapper.selectOne(new LambdaQueryWrapper<WorkspaceEntity>()
